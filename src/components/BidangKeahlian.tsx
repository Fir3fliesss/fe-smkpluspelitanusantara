    ...
    <section className="flex flex-col mx-4">
      <div className="xl:ml-64 xl:mr-64 md:ml-32 md:mr-32 hidden mt-8 md:flex md:justify-center xl:justify-center">
        ...
        <div className="md:ml-4">
          <h1 className="font-bold ml-6 xl:text-4xl md:text-2xl items-center dark:text-slate-200">
            INFORMASI BIDANG KEAHLIAN
          </h1>
          <div className="mt-4">
            <p className="ml-6 max-w-[100%] font-medium text-justify dark:text-slate-200">
